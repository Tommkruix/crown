            ...
            <div className="col-md-4">
              <div className="card mb-4 shadow-sm border border-secondary cw-why-us-card" style={{ height: '200px' }}>
                <div className="card-body ">
                  <p className="card-text bg-white" style={{ position: 'absolute', right: '-10px', top: '40%' }}>
                    Trust
                  </p>
                </div>
              </div>
        ...
        <div className="row">
          ...
          <div className="col-8 col-md">
            ...
            <ul className="list-unstyled text-small row">
              <li>
                <a className="text-muted text-gray-1 span6" href="#">
                  About Us
                </a>
              </li>
              <li>
                <a className="text-muted text-gray-1 ml-2" href="#">
                  Request
                </a>
              </li>
              <li>
          ...
          <div className="col-3">
            ...
            <ul className="list-unstyled text-small">
              <li>
                <span className="text-muted text-gray-2">Email: Email: info@needmoremed.com</span>
              </li>
              <li>
                <span className="text-muted text-gray-2">Address: Toronto, Canada</span>
              </li>
              <li>
                <a className="text-muted text-gray-1" href="#">
                  Terms and Policy
                </a>
              </li>
            </ul>
