...
const Support = props => {
  const onFinish = values => {
    axios.post('api/support', values).then(({ data }) => {
      Modal.success({
    ...
    <div className="support padding-all-15" data-name="support">
      <Row>
        <Col span={11} style={{ boxShadow: '5px 0 1px -2px grey', textAlign: 'center', marginLeft: '60px', paddingRight: '45px' }}>
          ...
          <Form name="normal_login" initialValues={{ remember: true }} onFinish={onFinish}>
            ...
            <Form.Item name="email" rules={[{ required: true, message: 'Please input your email!' }]}>
              <Input type="email" placeholder="Email" style={{ height: '50px', borderRadius: '10px' }} />
            </Form.Item>
            <Form.Item name="phoneNumber">
              <Input placeholder="Phone Number (Optional)" style={{ height: '50px', borderRadius: '10px' }} />
            </Form.Item>
        ...
        <Col span={10} style={{ textAlign: 'center', marginLeft: '110px', marginTop: '15vh' }}>
          {
            <div style={{ alignItems: 'center', width: '50vh' }}>
              ...
              <div id="reach-out" style={{ marginBottom: '20px' }}>
                ...
                <a href="mailto:info@needmoremed.com">info@needmoremed.com</a>
              </div>
